...
## Issues with DNS resolution after upgrading to MacOS Sequoia (15.x)

Due to changes in how MacOS handles the built-in firewall, you may experience DNS failures once connecting Warp after installing MacOS Sequoia or even subsequent updates of the same major version (15.0 > 15.1, etc)

#### Solution

Open the firewall settings within MacOS, disable "Block all incoming connections" and ensure "CloudflareWARP" has "Allow incoming connections" enabled.
